...
This project was originally bootstrapped with [Create React App](https://github.com/facebookincubator/create-react-app) and then ejected to provide starting code for a React/MobX-project with support for ES-7 decorators.
...
## All information below is from the original [Create React App](https://github.com/facebookincubator/create-react-app) Project
